import { Compiler, ResolveOptions } from 'webpack';
import {
  getConfig,
...
function normalizeResolverAlias(alias: ResolveOptions['alias']): Alias[] {
...
function applyAliases(
  ...
  compiler.hooks.afterResolvers.tap(name, (compiler: Compiler) => {
    compiler.resolverFactory.hooks.resolveOptions
      .for('normal')
      .tap(name, (resolveOptions: ResolveOptions) => {
