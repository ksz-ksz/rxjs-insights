...
export const combineLatest = operator('combineLatest', _combineLatest);
export const concat = operator('concat', _concat);
...
export const merge = operator('merge', _merge);
...
export const onErrorResumeNext = operator(
  'onErrorResumeNext',
  _onErrorResumeNext
);
...
export const race = operator('race', _race);
